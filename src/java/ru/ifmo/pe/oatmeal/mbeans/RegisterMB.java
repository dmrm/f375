...
public class RegisterMB {
    ...
    private void validateFile(String contentType, long fileSize) throws ValidatorException {
        if (!((contentType.equals("image/jpeg") || contentType.equals("image/bmp")
                || contentType.equals("image/gif") || contentType.equals("image/png"))
                && fileSize < maxFileSuze)) {
            FacesMessage message = new FacesMessage();
            message.setDetail("Type or size file not valid");
            message.setSummary("Type or size file not valid");
